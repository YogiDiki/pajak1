...
SECRET_KEY = 'django-insecure-36t!b(8a3+g_d_a*t%@7*!3#a@$x7g@g(f#g+a#n+x#o*b#n+n' # <-- Ganti dengan kunci rahasia unik Anda!
...
ALLOWED_HOSTS = ['*']  # sementara, nanti diganti ke nama render
