...
export default function Login() {
  ...
  return (
    <>
      <Helmet>
        <title>Masuk - Taxonomy Knowledge Hub</title>
        <meta name="description" content="Masuk ke akun Taxonomy Knowledge Hub untuk mengakses konten eksklusif dan fitur premium." />
      </Helmet>
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div className="mt-6 text-center">
              ...
              <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
                ...
                <p className="text-xs text-yellow-700">Default admin credentials:</p>
                <p className="text-xs text-yellow-700">Email: admin@pajakhub.com</p>
                <p className="text-xs text-yellow-700">Password: admin123</p>
                <button
                  type="button"
                  onClick={() => setFormData({ email: 'admin@pajakhub.com', password: 'admin123' })}
